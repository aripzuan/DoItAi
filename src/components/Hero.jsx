  ...
  return (
    <div className='relative min-h-screen flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            {/* Main heading */}
            <h1 className='text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-tight mb-6 animate-fade-in-up' style={{animationDelay: '0.2s'}}>
            ...
            {/* Subtitle */}
            <p className='text-lg sm:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto mb-8 leading-relaxed animate-fade-in-up' style={{animationDelay: '0.4s'}}>
                Design, write, and automate effortlessly — all in one intelligent platform built for creators who want to push boundaries.
            </p>

            {/* CTA Button */}
            <div className='flex justify-center items-center mb-12 animate-fade-in-up' style={{animationDelay: '0.6s'}}>
                <button 
                    onClick={()=> navigate('/ai')} 
            ...
            {/* Stats */}
            <div className='flex flex-col sm:flex-row items-center justify-center gap-8 text-white/80 animate-fade-in-up' style={{animationDelay: '0.8s'}}>
